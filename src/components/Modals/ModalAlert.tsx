...
export const ModalAlert = forwardRef<ModalHandle, ModalProps>(({ title, message, onClose, onConfirm }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex justify-end space-x-3">
        ...
        />
        <BaseButton text='Confirm' className='bg-blue-500 hover:bg-blue-600'
          onClick={() => {
